...
import { MTacceptInvitation, MTaddContact, MTaddUserToBlockList, MTdeclineInvitation, MTdeleteContact, MTfetchAllContacts, MTfetchContacts, MTgetAllContacts, MTgetAllContactsFromDB, MTgetAllContactsFromServer, MTgetBlockListFromDB, MTgetBlockListFromServer, MTgetContact, MTgetSelfIdsOnOtherPlatform, MTonContactChanged, MTremoveUserFromBlockList, MTsetContactRemark } from './__internal__/Consts';
...
export class ChatContactManager extends BaseManager {
  ...
  setNativeListener(event) {
    ...
    this._contactSubscriptions.set(MTonContactChanged, event.addListener(MTonContactChanged, params => {
  ...
  async addContact(userId) {
    ...
    let r = await Native._callMethod(MTaddContact, {
      [MTaddContact]: {
        username: userId,
        reason: reason
      }
  ...
  async deleteContact(userId) {
    ...
    let r = await Native._callMethod(MTdeleteContact, {
      [MTdeleteContact]: {
        username: userId,
  ...
  async getAllContactsFromServer() {
    ...
    let r = await Native._callMethod(MTgetAllContactsFromServer);
    ChatContactManager.checkErrorFromResult(r);
    const ret = r === null || r === void 0 ? void 0 : r[MTgetAllContactsFromServer];
    return ret;
  }
  ...
  async getAllContactsFromDB() {
    ...
    let r = await Native._callMethod(MTgetAllContactsFromDB);
    ChatContactManager.checkErrorFromResult(r);
    const ret = r === null || r === void 0 ? void 0 : r[MTgetAllContactsFromDB];
    return ret;
  }
  ...
  async addUserToBlockList(userId) {
    ...
    let r = await Native._callMethod(MTaddUserToBlockList, {
  ...
  async removeUserFromBlockList(userId) {
    ...
    let r = await Native._callMethod(MTremoveUserFromBlockList, {
  ...
  async getBlockListFromServer() {
    ...
    let r = await Native._callMethod(MTgetBlockListFromServer);
    ChatContactManager.checkErrorFromResult(r);
    const ret = r === null || r === void 0 ? void 0 : r[MTgetBlockListFromServer];
    return ret;
  }
  ...
  async getBlockListFromDB() {
    ...
    let r = await Native._callMethod(MTgetBlockListFromDB);
    ChatContactManager.checkErrorFromResult(r);
    const ret = r === null || r === void 0 ? void 0 : r[MTgetBlockListFromDB];
    return ret;
  }
  ...
  async acceptInvitation(userId) {
    ...
    let r = await Native._callMethod(MTacceptInvitation, {
      [MTacceptInvitation]: {
        username: userId
      }
    });
  ...
  async declineInvitation(userId) {
    ...
    let r = await Native._callMethod(MTdeclineInvitation, {
      [MTdeclineInvitation]: {
        username: userId
      }
    });
  ...
  async getSelfIdsOnOtherPlatform() {
    ...
    let r = await Native._callMethod(MTgetSelfIdsOnOtherPlatform);
    ChatContactManager.checkErrorFromResult(r);
    const ret = r === null || r === void 0 ? void 0 : r[MTgetSelfIdsOnOtherPlatform];
    return ret;
  }
  ...
  async getAllContacts() {
    ...
    let r = await Native._callMethod(MTgetAllContacts);
    ChatContactManager.checkErrorFromResult(r);
    const list = r === null || r === void 0 ? void 0 : r[MTgetAllContacts];
    const ret = [];
    for (const i of list) {
  ...
  async getContact(userId) {
    ...
    let r = await Native._callMethod(MTgetContact, {
      [MTgetContact]: {
        userId
      }
    });
    ChatContactManager.checkErrorFromResult(r);
    const g = r === null || r === void 0 ? void 0 : r[MTgetContact];
    if (g) {
  ...
  async fetchAllContacts() {
    ...
    let r = await Native._callMethod(MTfetchAllContacts);
    ChatContactManager.checkErrorFromResult(r);
    const list = r === null || r === void 0 ? void 0 : r[MTfetchAllContacts];
    const ret = [];
    for (const i of list) {
      ret.push(new ChatContact(i));
    }
  ...
  async fetchContacts(params) {
    chatlog.log(`${ChatContactManager.TAG}: fetchContacts: ${params.cursor}, ${params.pageSize}`);
    let r = await Native._callMethod(MTfetchContacts, {
      [MTfetchContacts]: {
    ...
    let ret = new ChatCursorResult({
      cursor: r === null || r === void 0 ? void 0 : r[MTfetchContacts].cursor,
      list: r === null || r === void 0 ? void 0 : r[MTfetchContacts].list,
      opt: {
        map: param => {
  ...
  async setContactRemark(contact) {
    ...
    let r = await Native._callMethod(MTsetContactRemark, {
      [MTsetContactRemark]: {
