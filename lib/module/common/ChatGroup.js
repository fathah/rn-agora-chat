 ...
 * The group types.
 */
export let ChatGroupStyle = /*#__PURE__*/function (ChatGroupStyle) {
 ...
 */
export let ChatGroupPermissionType = /*#__PURE__*/function (ChatGroupPermissionType) {
 ...
 */
export function ChatGroupStyleFromNumber(params) {
  switch (params) {
    case 0:
 ...
 */
export function ChatGroupStyleToString(params) {
 ...
 */
export function ChatGroupPermissionTypeFromNumber(params) {
  switch (params) {
    case -1:
 ...
 */
export function ChatGroupPermissionTypeToString(params) {
