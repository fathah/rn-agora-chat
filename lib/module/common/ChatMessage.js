...
import { ChatException } from './ChatError';
/**
 * The conversation types.
 */
export let ChatMessageChatType = /*#__PURE__*/function (ChatMessageChatType) {
 ...
 */
export let ChatMessageDirection = /*#__PURE__*/function (ChatMessageDirection) {
 ...
 */
export let ChatDownloadStatus = /*#__PURE__*/function (ChatDownloadStatus) {
 ...
 */
export let ChatRoomMessagePriority = /*#__PURE__*/function (ChatRoomMessagePriority) {
 ...
 */
export let ChatMessagePinOperation = /*#__PURE__*/function (ChatMessagePinOperation) {
 ...
 */
export let ChatMessageSearchScope = /*#__PURE__*/function (ChatMessageSearchScope) {
 ...
 */
export function ChatMessageChatTypeFromNumber(params) {
  switch (params) {
    case 2:
 ...
 */
export function ChatMessageDirectionFromString(params) {
  switch (params) {
    case 'send':
 ...
 */
export function ChatMessageStatusFromNumber(params) {
  switch (params) {
    case 3:
 ...
 */
export function ChatMessageStatusToString(params) {
 ...
 */
export function ChatDownloadStatusFromNumber(params) {
  switch (params) {
    case 0:
 ...
 * @returns The message download status of the string type.
 */
export function ChatDownloadStatusToString(params) {
 ...
 */
export function ChatMessageTypeFromString(params) {
  switch (params) {
    case 'txt':
