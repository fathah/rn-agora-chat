...
export const MTonMultiDeviceEventRemoveMessage = 'onMultiDeviceEventRemoveMessage';
export const MTonMultiDeviceEventConversation = 'onMultiDeviceEventConversation';
...
export const MTfetchConversationsFromServerWithPage = 'fetchConversationsFromServerWithPage';
export const MTremoveMessagesFromServerWithMsgIds = 'removeMessagesFromServerWithMsgIds';
export const MTremoveMessagesFromServerWithTs = 'removeMessagesFromServerWithTs';
export const MTgetConversationsFromServerWithCursor = 'getConversationsFromServerWithCursor';
export const MTgetPinnedConversationsFromServerWithCursor = 'getPinnedConversationsFromServerWithCursor';
export const MTpinConversation = 'pinConversation';
export const MTmodifyMessage = 'modifyMessage';
export const MTdownloadAndParseCombineMessage = 'downloadAndParseCombineMessage';
...
export const MTonReadAckForGroupMessageUpdated = 'onReadAckForGroupMessageUpdated';
...
export const MTfetchPublicChatRoomsFromServer = 'fetchPublicChatRoomsFromServer';
...
export const MTremoveMembersFromChatRoomAllowList = 'removeMembersFromChatRoomAllowList';
export const MTfetchChatRoomAllowListFromServer = 'fetchChatRoomAllowListFromServer';
export const MTisMemberInChatRoomAllowListFromServer = 'isMemberInChatRoomAllowListFromServer';
...
export const MTgetGroupsWithoutPushNotification = 'getGroupsWithoutPushNotification';
...
export const MTgetGroupSpecificationFromServer = 'getGroupSpecificationFromServer';
...
export const MTgetGroupAnnouncementFromServer = 'getGroupAnnouncementFromServer';
...
export const MTfetchMemberAttributesFromGroup = 'fetchMemberAttributesFromGroup';
export const MTfetchMembersAttributesFromGroup = 'fetchMembersAttributesFromGroup';
...
export const MTfetchSilentModeForConversations = 'fetchSilentModeForConversations';
export const MTsetPreferredNotificationLanguage = 'setPreferredNotificationLanguage';
export const MTfetchPreferredNotificationLanguage = 'fetchPreferredNotificationLanguage';
...
export const MTpublishPresenceWithDescription = 'publishPresenceWithDescription';
export const MTpresenceSubscribe = 'presenceSubscribe';
export const MTpresenceUnsubscribe = 'presenceUnsubscribe';
export const MTfetchSubscribedMembersWithPageNum = 'fetchSubscribedMembersWithPageNum';
...
export const MTfetchJoinedChatThreadsWithParentId = 'fetchJoinedChatThreadsWithParentId';
export const MTfetchChatThreadMember = 'fetchChatThreadMember';
export const MTfetchLastMessageWithChatThreads = 'fetchLastMessageWithChatThreads';
...
export const MTaddRemoteAndLocalConversationsMark = 'addRemoteAndLocalConversationsMark';
export const MTdeleteRemoteAndLocalConversationsMark = 'deleteRemoteAndLocalConversationsMark';
export const MTfetchConversationsByOptions = 'fetchConversationsByOptions';
export const MTdeleteAllMessageAndConversation = 'deleteAllMessageAndConversation';
