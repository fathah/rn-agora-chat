...
exports.ChatConversationType = exports.ChatConversationMarkType = exports.ChatConversationFetchOptions = exports.ChatConversation = void 0;
...
exports.ChatSearchDirection = void 0;
 ...
 *
 */
let ChatSearchDirection = /*#__PURE__*/function (ChatSearchDirection) {
 ...
 */
exports.ChatSearchDirection = ChatSearchDirection;
let ChatConversationType = /*#__PURE__*/function (ChatConversationType) {
...
let ChatConversationMarkType = /*#__PURE__*/function (ChatConversationMarkType) {
 ...
 */
exports.ChatConversationMarkType = ChatConversationMarkType;
...
class ChatConversation {
  ...
  async name() {
    if (this.convType === ChatConversationType.PeerChat) {
      const ret = await _ChatClient.ChatClient.getInstance().userManager.fetchUserInfoById([this.convId]);
      if (ret.size > 0) {
      ...
      const ret = await _ChatClient.ChatClient.getInstance().groupManager.fetchGroupInfoFromServer(this.convId);
      if (ret) {
        return ret.groupName;
      }
    } else if (this.convType === ChatConversationType.RoomChat) {
      const ret = await _ChatClient.ChatClient.getInstance().roomManager.fetchChatRoomInfoFromServer(this.convId);
      if (ret) {
        return ret.roomName;
      }
    } else {
  ...
  async getUnreadCount() {
    return _ChatClient.ChatClient.getInstance().chatManager.getConversationUnreadCount(this.convId, this.convType, this.isChatThread);
  }
  ...
  async getMessageCount() {
    return _ChatClient.ChatClient.getInstance().chatManager.getConversationMessageCount(this.convId, this.convType, this.isChatThread);
  }
  ...
  async getLatestMessage() {
    return _ChatClient.ChatClient.getInstance().chatManager.getLatestMessage(this.convId, this.convType, this.isChatThread);
  }
  ...
  async getLatestReceivedMessage() {
    return _ChatClient.ChatClient.getInstance().chatManager.getLatestReceivedMessage(this.convId, this.convType, this.isChatThread);
  }
  ...
  async setConversationExtension(ext) {
    await _ChatClient.ChatClient.getInstance().chatManager.setConversationExtension(this.convId, this.convType, this.ext, this.isChatThread);
    this.ext = ext;
  }
  ...
  async markMessageAsRead(msgId) {
    return _ChatClient.ChatClient.getInstance().chatManager.markMessageAsRead(this.convId, this.convType, msgId, this.isChatThread);
  }
  ...
  async markAllMessagesAsRead() {
    return _ChatClient.ChatClient.getInstance().chatManager.markAllMessagesAsRead(this.convId, this.convType, this.isChatThread);
  }
  ...
  async updateMessage(msg) {
    ...
    return _ChatClient.ChatClient.getInstance().chatManager.updateConversationMessage(this.convId, this.convType, msg, this.isChatThread);
  }
  ...
  async deleteMessage(msgId) {
    return _ChatClient.ChatClient.getInstance().chatManager.deleteMessage(this.convId, this.convType, msgId, this.isChatThread);
  }
  ...
  async deleteMessagesWithTimestamp(params) {
    return _ChatClient.ChatClient.getInstance().chatManager.deleteMessagesWithTimestamp(this.convId, this.convType, params, this.isChatThread);
  }
  ...
  async deleteAllMessages() {
    return _ChatClient.ChatClient.getInstance().chatManager.deleteConversationAllMessages(this.convId, this.convType, this.isChatThread);
  }
  ...
  async getMessagesWithMsgType(msgType) {
    ...
    return _ChatClient.ChatClient.getInstance().chatManager.getMessagesWithMsgType(this.convId, this.convType, msgType, direction, timestamp, count, sender, this.isChatThread);
  }
  ...
  async getMsgsWithMsgType(params) {
    return _ChatClient.ChatClient.getInstance().chatManager.getMsgsWithMsgType({
      ...params,
      convId: this.convId,
  ...
  async getMessages(startMsgId) {
    ...
    return _ChatClient.ChatClient.getInstance().chatManager.getMessages(this.convId, this.convType, startMsgId, direction, loadCount, this.isChatThread);
  }
  ...
  async getMsgs(params) {
    return _ChatClient.ChatClient.getInstance().chatManager.getMsgs({
      ...params,
      convId: this.convId,
      convType: this.convType,
      isChatThread: this.isChatThread
  ...
  async getMessagesWithKeyword(keywords) {
    ...
    let count = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 20;
    let sender = arguments.length > 4 ? arguments[4] : undefined;
    return _ChatClient.ChatClient.getInstance().chatManager.getMessagesWithKeyword(this.convId, this.convType, keywords, direction, timestamp, count, sender, this.isChatThread);
  }
  ...
  async getMsgsWithKeyword(params) {
    return _ChatClient.ChatClient.getInstance().chatManager.getConvMsgsWithKeyword({
      ...params,
      convId: this.convId,
      convType: this.convType,
      isChatThread: this.isChatThread
  ...
  async getMessageWithTimestamp(startTime, endTime) {
    ...
    let count = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : 20;
    return _ChatClient.ChatClient.getInstance().chatManager.getMessageWithTimestamp(this.convId, this.convType, startTime, endTime, direction, count, this.isChatThread);
  }
  ...
  async getMsgWithTimestamp(params) {
    return _ChatClient.ChatClient.getInstance().chatManager.getMsgWithTimestamp({
      ...params,
      convId: this.convId,
      convType: this.convType,
      isChatThread: this.isChatThread
  ...
  async removeMessagesFromServerWithMsgIds(msgIds) {
    return _ChatClient.ChatClient.getInstance().chatManager.removeMessagesFromServerWithMsgIds(this.convId, this.convType, msgIds, this.isChatThread);
  }
  ...
  async removeMessagesFromServerWithTimestamp(timestamp) {
    return _ChatClient.ChatClient.getInstance().chatManager.removeMessagesFromServerWithTimestamp(this.convId, this.convType, timestamp, this.isChatThread);
  }
  ...
  async getPinnedMessages() {
    return _ChatClient.ChatClient.getInstance().chatManager.getPinnedMessages(this.convId, this.convType, this.isChatThread);
  }
  ...
  async fetchPinnedMessages() {
    return _ChatClient.ChatClient.getInstance().chatManager.fetchPinnedMessages(this.convId, this.convType, this.isChatThread);
  }
}
...
exports.ChatConversationFetchOptions = ChatConversationFetchOptions;
