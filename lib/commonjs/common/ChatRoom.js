...
exports.ChatRoomPermissionType = exports.ChatRoom = void 0;
exports.ChatRoomPermissionTypeFromNumber = ChatRoomPermissionTypeFromNumber;
exports.ChatRoomPermissionTypeToString = ChatRoomPermissionTypeToString;
/**
 * The chat room role types.
 */
let ChatRoomPermissionType = /*#__PURE__*/function (ChatRoomPermissionType) {
 ...
 */
exports.ChatRoomPermissionType = ChatRoomPermissionType;
function ChatRoomPermissionTypeFromNumber(params) {
  switch (params) {
    case -1:
 ...
 */
function ChatRoomPermissionTypeToString(params) {
